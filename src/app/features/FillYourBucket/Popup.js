          ...
          >
            {step === 1 && <ProblemSolvingPopup className="popup_card">
              ...
              <div className="popup_text_btn">
                <div className="popup_btn" onClick={() => { setIsuseful(false); setStep(2) }}>No</div>
                <div className="popup_btn popup_btn_yes" onClick={() => { setIsuseful(true); setStep(3) }}>Yes</div>
              </div>
            </ProblemSolvingPopup>}
            {step === 3 && <ProblemSolvingPopup className="popup_card">
              ...
              <div className="popup_text_btn">
                <div className="popup_btn" onClick={() => { props.setScreen(1) }} >No</div>
