...
const FT_BASE_URL = '/flexible-thinking';
const HEADERS =
...
export const stepInitialTwo = (data) => {
  return new Promise((resolve, reject) => {
    axios
      .post(`${FT_BASE_URL}/initial/step2`, data, {
        headers: {
          Authorization: HEADERS,
        },
      })
...
export const getHistory = () => {
  return new Promise((resolve, reject) => {
    axios
      .get(`${FT_BASE_URL}/history?page=1&perPage=100`, {
        headers: {
          Authorization: HEADERS,
        },
      })
